...
*/ -}}
{{- define "eric-oss-common-ci-pocs-egookat-test.aggregatedMerge" -}}
  {{- $merged := dict -}}
  {{- $context := .context -}}
  {{- $location := .location -}}
...
*/ -}}
{{- define "eric-oss-common-ci-pocs-egookat-test.mergeAnnotations" -}}
  {{- include "eric-oss-common-ci-pocs-egookat-test.aggregatedMerge" (dict "context" "annotations" "location" .location "sources" .sources) }}
{{- end -}}
{{- define "eric-oss-common-ci-pocs-egookat-test.mergeLabels" -}}
  {{- include "eric-oss-common-ci-pocs-egookat-test.aggregatedMerge" (dict "context" "labels" "location" .location "sources" .sources) }}
{{- end -}}
